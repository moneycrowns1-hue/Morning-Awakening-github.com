...
export const MISSIONS: Mission[] = [
  ...
  // ═══ BLOQUE 2: VENTANA ANABÓLICA (6:00 - 6:15) ═══
  {
    ...
    directive: 'Repostaje + higiene de transición: ingesta enfocada (proteína, carbos complejos, grasas), lavado de cara, hidratante con SPF y enjuague con agua — sin cepillarte los dientes todavía.',
    duration: 900,
    ...
    subSteps: [
      ...
      { label: 'Lavar la cara · agua fresca', description: 'Despierta los vasos faciales y cierra poros tras la vasodilatación del cardio.' },
      { label: 'Hidratante + protector solar', description: 'Piel limpia post-ducha absorbe mejor. SPF desde el amanecer, no negociable.' },
  ...
  // ═══ CIERRE · EL ANCLAJE FINAL (6:45 - 6:50) ═══
  {
    ...
    directive: 'Higiene dental de élite: hilo + cepillado riguroso ahora que el pH bucal se estabilizó. El frescor final sella el protocolo y da inicio a la ejecución operativa.',
    duration: 300,
    systemLog: 'FINAL SEAL — DENTAL HYGIENE ELITE.',
    completionLog: 'GÉNESIS COMPLETE. READY TO CONQUER THE CORE.',
    scienceNote: 'Tras 45 min post-ingesta, el pH bucal vuelve a neutro y el esmalte ya no está desmineralizado: es cuando el cepillado protege sin erosionar. Además, el frescor de la menta en la cavidad oral actúa como "imprinting" sensorial — el cerebro asocia esa señal con la transición de preparación → ejecución.',
    subSteps: [
      { label: 'Hilo dental primero', description: 'Remueve residuos interproximales antes de cepillar.' },
      { label: 'Cepillado riguroso · técnica Bass', description: '45°, movimientos cortos, 2 min completos.' },
      { label: 'Enjuague y lengua', description: 'Limpia también la lengua — ahí está el 70 % de la carga bacteriana.' },
      { label: 'Sello final', description: 'El frescor marca el fin del protocolo. Empieza la ejecución.' },
    ],
    tips: [
