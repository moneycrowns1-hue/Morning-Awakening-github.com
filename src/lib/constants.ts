...
export const MISSIONS: Mission[] = [
  ...
  // ═══ BLOQUE 2: VENTANA ANABÓLICA (6:00 - 6:15) ═══
  {
    ...
    subSteps: [
      ...
      { label: 'Skincare · limpieza 60 s', description: 'Limpiador suave en círculos durante 60 segundos. Disuelve sebo, sudor y suciedad sin agredir la barrera.' },
      { label: 'Skincare · spray / tónico', description: 'Hidrata la primera capa y reequilibra el pH antes de los activos.' },
      { label: 'Skincare · serum', description: 'Activos concentrados (vitamina C, niácinamida, péptidos) sobre piel ligeramente húmeda — máxima penetración.' },
