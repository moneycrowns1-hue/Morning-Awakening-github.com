...
const AM_NORMAL: Routine = {
  ...
  steps: [
    ...
    { productId: 'bioderma_sensibio_defensive', action: 'Aplicar Sensibio Defensive Serum', applySkinState: 'damp' },
    {
      ...
      action: 'Aplicar Ceramid Gel (alternativa más ligera)',
      applySkinState: 'damp',
      optional: true,
      swapGroup: 'am_moisturizer',
      note: 'Si AM se siente pesada, sustituir CeraVe AM por Ceramid Gel + SPF aparte.',
    },
    { productId: 'cerave_am_spf30', action: 'CeraVe AM Lotion SPF 30', applySkinState: 'dry', note: 'Hidratante con SPF 30 base.' },
    ...
    { productId: 'bioderma_sensibio_eye', action: 'Sensibio Eye en contorno', applySkinState: 'dry', optional: true, swapGroup: 'eye_care' },
    { productId: 'cerave_eye_repair', action: 'CeraVe Eye Repair (alternativa)', applySkinState: 'dry', optional: true, swapGroup: 'eye_care' },
...
const PM_NORMAL: Routine = {
  ...
  steps: [
    ...
    {
      productId: 'ceramid_gel_siegfried',
      action: 'Ceramid Gel (alternativa más ligera)',
      applySkinState: 'damp',
      optional: true,
      swapGroup: 'pm_moisturizer',
    },
    { productId: 'cerave_moisturizing_cream', action: 'Sellar con CeraVe Moisturizing Cream', applySkinState: 'damp', swapGroup: 'pm_moisturizer' },
    { productId: 'bioderma_sensibio_eye', action: 'Contorno de ojos', applySkinState: 'dry', optional: true, swapGroup: 'eye_care' },
    { productId: 'cerave_eye_repair', action: 'CeraVe Eye Repair (alternativa)', applySkinState: 'dry', optional: true, swapGroup: 'eye_care' },
