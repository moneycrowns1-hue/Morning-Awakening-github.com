...
import type { NightMission } from '@/lib/nightConstants';
import { NIGHT_MISSIONS } from '@/lib/nightConstants';
...
import { getNightStageColors, NIGHT, NIGHT_TEXT } from '@/lib/nightTheme';
    ...
    >
      ...
      {showCompletado && (
        ...
        >
          <div className="text-center select-none">
            <div
              className="font-display italic font-[400] text-4xl md:text-5xl tracking-[0.04em]"
              style={{
      ...
      >
        <div className="w-full flex flex-col items-center text-center mt-2">
          <h1
            className="font-display italic font-[400] leading-[1.12] text-[clamp(1.8rem,7vw,2.4rem)]"
            style={{ color: NIGHT_TEXT.primary }}
          >
